...
def main():
    ...
    search_in = '/home/sun.chengkun/ondemand/data/Kits/unetqkv/experiment_planning'
    ...
    for t in tasks:
        ...
        #/data/datasets/chengkun/kits23/nnUNet_raw_data_base/nnUNet_cropped_data/target_image_label_process/Task040_KiTS
        preprocessing_output_dir_this_task = os.path.join(preprocessing_output_dir, t)
        #/data/datasets/chengkun/kits23/nnUNet_preprocessed/target_image_label_process/Task040_KiTS
        ...
        #/data/datasets/chengkun/kits23/nnUNet_preprocessed/target_image_label_process/Task040_KiTS/dataset_properties.pkl
        shutil.copy(join(nnUNet_raw_data, t, "dataset.json"), preprocessing_output_dir_this_task)
        #/data/datasets/chengkun/kits23/nnUNet_preprocessed/target_image_label_process/Task040_KiTS/dataset.json
