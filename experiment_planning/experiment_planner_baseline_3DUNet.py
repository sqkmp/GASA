...
import sys
sys.path.append("/home/Renal_image/Kits23")
...
from trainer.generic_UNet import Generic_UNet
#from nnunet.paths import *
from utils.cropping import get_case_identifier_from_npz
#from nnunet.training.model_restore import recursive_find_python_class
from utils.preprocessing import GenericPreprocessor
...
class ExperimentPlanner(object):
    ...
    def plan_experiment(self):
        use_nonzero_mask_for_normalization = self.determine_whether_to_use_mask_for_norm() #False
        ...
        print([np.argwhere(np.array(self.transpose_forward) == i) for i in range(3)])
        # sys.exit()
    ...
    def run_preprocessing(self, num_threads):
        ...
        #preprocessor_class = recursive_find_python_class([join("/home/sun.chengkun/Renal_image/nnUNet/nnunet", "preprocessing")],
        #                                                 self.preprocessor_name, current_module="nnpreprocessing")
