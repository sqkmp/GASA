...
if __name__ == '__main__':
    ...
    folder_pred = '/orange/unet_data/nnUNet_trained_models/nnunet_qkv25d5/unet3c_all'
    output_file = '/orange/unet_data/nnUNet_trained_models/nnunet_qkv25d5/unet3c_all.json'
