...
from utils.configuration import default_num_threads
#from utils.paths import preprocessing_output_dir
from batchgenerators.utilities.file_and_folder_operations import *

preprocessing_output_dir = "/data/datasets/kits23/nnUNet_preprocessed"
