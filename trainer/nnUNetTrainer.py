...
from utils.connected_components import determine_postprocessing
...
from utils.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def process_plans(self, plans):
        ...
        self.normalization_schemes = plans['normalization_schemes'] # OrderedDict([(0, 'CT')])
        self.base_num_features = plans['base_num_features'] #32
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor = preprocessor_class(self.plans['normalization_schemes'], self.plans['use_mask_for_norm'],
                                          self.transpose_forward, self.plans['dataset_properties']['intensityproperties'])
